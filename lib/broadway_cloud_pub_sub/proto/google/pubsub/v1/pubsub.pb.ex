defmodule Google.Pubsub.V1.IngestionDataSourceSettings.AwsKinesis.State do
  ...
  use Protobuf,
    enum: true,
    full_name: "google.pubsub.v1.IngestionDataSourceSettings.AwsKinesis.State",
...
defmodule Google.Pubsub.V1.IngestionDataSourceSettings.CloudStorage.State do
  ...
  use Protobuf,
    enum: true,
    full_name: "google.pubsub.v1.IngestionDataSourceSettings.CloudStorage.State",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Google.Pubsub.V1.IngestionDataSourceSettings.AzureEventHubs.State do
  ...
  use Protobuf,
    enum: true,
    full_name: "google.pubsub.v1.IngestionDataSourceSettings.AzureEventHubs.State",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Google.Pubsub.V1.IngestionDataSourceSettings.AwsMsk.State do
  ...
  use Protobuf,
    enum: true,
    full_name: "google.pubsub.v1.IngestionDataSourceSettings.AwsMsk.State",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Google.Pubsub.V1.IngestionDataSourceSettings.ConfluentCloud.State do
  ...
  use Protobuf,
    enum: true,
    full_name: "google.pubsub.v1.IngestionDataSourceSettings.ConfluentCloud.State",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Google.Pubsub.V1.PlatformLogsSettings.Severity do
  ...
  use Protobuf,
    enum: true,
    full_name: "google.pubsub.v1.PlatformLogsSettings.Severity",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Google.Pubsub.V1.Topic.State do
  ...
  use Protobuf,
    enum: true,
    full_name: "google.pubsub.v1.Topic.State",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Google.Pubsub.V1.Subscription.State do
  ...
  use Protobuf,
    enum: true,
    full_name: "google.pubsub.v1.Subscription.State",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Google.Pubsub.V1.BigQueryConfig.State do
  ...
  use Protobuf,
    enum: true,
    full_name: "google.pubsub.v1.BigQueryConfig.State",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Google.Pubsub.V1.BigtableConfig.State do
  ...
  use Protobuf,
    enum: true,
    full_name: "google.pubsub.v1.BigtableConfig.State",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
  ...
  field(:ACTIVE, 1)
  field(:NOT_FOUND, 2)
  field(:APP_PROFILE_MISCONFIGURED, 3)
  field(:PERMISSION_DENIED, 4)
  field(:SCHEMA_MISMATCH, 5)
  field(:IN_TRANSIT_LOCATION_RESTRICTION, 6)
  field(:VERTEX_AI_LOCATION_RESTRICTION, 7)
end
...
defmodule Google.Pubsub.V1.CloudStorageConfig.State do
  ...
  use Protobuf,
    enum: true,
    full_name: "google.pubsub.v1.CloudStorageConfig.State",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Google.Pubsub.V1.Subscription do
  ...
  field(:bigtable_config, 27,
    type: Google.Pubsub.V1.BigtableConfig,
    json_name: "bigtableConfig",
    deprecated: false
  )
...
defmodule Google.Pubsub.V1.BigtableConfig do
  ...
  field(:write_metadata, 5, type: :bool, json_name: "writeMetadata", deprecated: false)
  field(:state, 4, type: Google.Pubsub.V1.BigtableConfig.State, enum: true, deprecated: false)
end
